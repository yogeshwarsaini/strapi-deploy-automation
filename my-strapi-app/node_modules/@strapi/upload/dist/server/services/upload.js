...
var upload = (({ strapi })=>{
   ...
   */ async function uploadFileAndPersist(fileData, opts) {
    ...
    function findOne(id, populate = {}) {
        ...
        return strapi.db.query(constants.FILE_MODEL_UID).findOne({
            where: {
                id
            },
            ...query
    ...
    function findMany(query = {}) {
        return strapi.db.query(constants.FILE_MODEL_UID).findMany(strapi.get('query-params').transform(constants.FILE_MODEL_UID, query));
    }
    function findPage(query = {}) {
        return strapi.db.query(constants.FILE_MODEL_UID).findPage(strapi.get('query-params').transform(constants.FILE_MODEL_UID, query));
    }
